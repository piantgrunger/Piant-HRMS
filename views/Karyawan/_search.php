...
<div class="karyawan-search">
    ...
    <?php // echo $form->field($model, 'tgl_efektif') ?>

    <?php // echo $form->field($model, 'tgl_keluar') ?>

    <?php // echo $form->field($model, 'stat_karyawan') ?>

    <?php // echo $form->field($model, 'stat_kerja') ?>

    <?php // echo $form->field($model, 'stat_wna') ?>

    <?php // echo $form->field($model, 'id_divisi') ?>

    <?php // echo $form->field($model, 'id_departemen') ?>

    <?php // echo $form->field($model, 'id_seksi') ?>

    <?php // echo $form->field($model, 'id_jabatan') ?>

    <?php // echo $form->field($model, 'stat_serikat_pegawai') ?>
